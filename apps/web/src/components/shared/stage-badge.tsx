...
const stageColors: Record<number, string> = {
  0: 'bg-slate-100 text-slate-700',     // lead_created
  1: 'bg-blue-100 text-blue-700',       // intake_completed
  2: 'bg-blue-100 text-blue-700',       // qualified
  3: 'bg-indigo-100 text-indigo-700',   // counsellor_consultation
  4: 'bg-indigo-100 text-indigo-700',   // application_started
  5: 'bg-sky-100 text-sky-700',         // offer_confirmed
