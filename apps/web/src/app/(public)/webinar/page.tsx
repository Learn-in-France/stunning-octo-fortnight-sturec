...
export const metadata: Metadata = {
  ...
  description:
    'Live with current BSB students and an Indian professional in France. Sunday, 11 May 2026 at 6:00 PM IST. Reserve your seat — only 200 spots.',
  alternates: { canonical: 'https://learninfrance.com/webinar' },
  openGraph: {
    title: 'From India to France — Live Webinar',
    description:
      'BSB students + Indian professional in France. Sunday, 11 May at 6 PM IST. RSVP now.',
